...
fun SignUp(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            visualTransformation = if (signUpViewModel.passwordHidden) PasswordVisualTransformation() else VisualTransformation.None,
            placeholder = { Text(text = "•••••••••") },
            trailingIcon = {
                IconButton (
                    onClick = { signUpViewModel.togglePasswordVisibility() }
                ) {

                    val visibilityIcon =
                        if (signUpViewModel.passwordHidden) Icons.Outlined.Visibility else Icons.Outlined.VisibilityOff

                    val description = if (signUpViewModel.passwordHidden) "Show password" else "Hide password"
        ...
        Row(
            ...
            Row(
                ...
                Checkbox(
                    checked = signUpViewModel.rememberMe,
                    onCheckedChange = { signUpViewModel.updateRememberMe(it) },
